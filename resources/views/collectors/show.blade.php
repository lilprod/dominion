        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Collecteurs</h5>
                        <span>Profil du collecteur</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Profil du collecteur</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center"> 
                        <img src="{{ $collector->profile_picture }}" class="rounded-circle" width="150" />
                        <h4 class="card-title mt-10">{{$collector->name}} {{$collector->firstname}}</h4>
                            	...
                            	<div class="sl-item">
                                    ...
                                    <div class="sl-right">
                                        ...
                                        <div class="like-comm mt-20"> 
                                            ...
                                            <div class="rating">
                                                    <input type="hidden" name="client_id" value="{{ $collector->id }}">
                                                <input id="input-1" name="rate" class="rating rating-loading" data-min="0" data-max="5" data-step="1" value="{{ $collector->userAverageRating }}" data-size="xs">
                                ...
                                <div class="sl-item">
                                  ...
                                  <form class="forms-sample" method="POST" action="{{ route('comments.store') }}">
                                           ...
                                           <div class="form-group">
                                           		...
                                           		<input type="hidden" name="collector_userid" value="{{$collector->user_id}}">
