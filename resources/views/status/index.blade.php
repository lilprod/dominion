        ...
        <div class="col-lg-4">
            <nav class="breadcrumb-container" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Liste des états</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                  ...
                  <div class="modal-body">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p>Etes-vous sûr(e) de vouloir supprimer cet état d'article?</p>
                  </div>
      ...
      @include('inc.messages')
        <div class="card">
            <div class="card-header with-border">
                ...
                <a href="{{ route('status.create') }}" class="btn btn-default pull-right"><i class='fa fa-plus-square'></i> Ajouter Etat</a>
            </div>
            <!-- /.box-header -->
            <div class="card-body">
                <table id="data_table" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="{{ route('status.edit', $etat->id) }}" class="" style="margin-right: 3px;"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
            ...
            <div class="card-footer clearfix">
              <a href="{{ route('status.create') }}" class="btn btn-primary"><i class='fa fa-plus-square'></i>  Ajouter Etat</a>
            </div>
        </div>
    </div>
</div>
