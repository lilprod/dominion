                ...
                <table id="data_table" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <p><b>Nettoyage et Repassage :</b> {{ $article->nettoyage_price }}</p>
                              <p><b>Repassage :</b> {{ $article->repassage_price }}</p>
                              <p><b>Nettoyage Express :</b> {{ $article->lavage_price }}</p>
                              
                            </td>
                            <td>{{ $article->created_at->format('F d, Y h:ia') }}</td>
                            <td>
                            <a href="{{ route('articles.edit', $article->id) }}" class="" style="margin-right: 3px;"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
