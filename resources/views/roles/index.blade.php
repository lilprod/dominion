        ...
        <div class="card">
            ...
            <!-- /.box-header -->
                    ...
                    <table id="data_table" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="{{ URL::to('roles/'.$role->id.'/edit') }}" class="" style="margin-right: 3px;"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>

                                <a href="javascript:;" data-toggle="modal" onclick="deleteData({{ $role->id}})" data-target="#confirm" class=""><i class="ik ik-trash-2 f-16 text-red"></i></a>
                ...
                <div class="card-footer clearfix">
                  <a href="{{ URL::to('roles/create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Ajouter rôle</a>
                </div>
